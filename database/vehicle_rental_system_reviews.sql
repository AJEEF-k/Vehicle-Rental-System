...
CREATE TABLE `reviews` (
  ...
  CONSTRAINT `fk_review_booking` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`booking_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `reviews_chk_1` CHECK ((`vehicle_rating` between 1 and 5)),
  CONSTRAINT `reviews_chk_2` CHECK ((`vendor_rating` between 1 and 5))
