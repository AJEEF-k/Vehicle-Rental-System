...
@WebServlet("/vendor/change-password")
    ...
    protected void doPost(HttpServletRequest request,
        ...
        if (currentPassword == null
            ...
            response.sendRedirect(
                    ...
                    + "/vendor/change-password?error=required");
        ...
        if (!PasswordUtil.verifyPassword(
            ...
            response.sendRedirect(
                    request.getContextPath()
                    + "/vendor/change-password?error=currentPassword");
        ...
        if (!ValidationUtil.isValidPassword(newPassword)) {
            ...
            response.sendRedirect(
                    request.getContextPath()
                    + "/vendor/change-password?error=password");
        ...
        if (!newPassword.equals(confirmPassword)) {
            ...
            response.sendRedirect(
                    request.getContextPath()
                    + "/vendor/change-password?error=mismatch");
        ...
        if (PasswordUtil.verifyPassword(
            ...
            response.sendRedirect(
                    request.getContextPath()
                    + "/vendor/change-password?error=samePassword");
        ...
        if (updated) {
            ...
            response.sendRedirect(
                    request.getContextPath()
                    + "/vendor/change-password?success=updated");

        } else {

            response.sendRedirect(
                    request.getContextPath()
                    + "/vendor/change-password?error=failed");
        }
    }
}